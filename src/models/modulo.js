...
module.exports = { //Criando os módulos da entidade módulo

    async create(data) {  //Função para criar os módulos
    ...
    async findById(id) { //Função para encontrar módulo por id
    ...
    async findByTrailId(data) { // Função para encontrar módulo pelo id da trilha
    ...
    async findByUserId(data) { // Função para encontrar modulo pelo id do usuário
    ...
    async update(id, data) {  //Função para atualizar trilhas
    ...
    async delete(id) { // Função para deletar trilhas
